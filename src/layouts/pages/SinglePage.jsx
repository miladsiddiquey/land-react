                        ...
                        <div className='d-flex align-items-center gap-2'>
                            ...
                            <Modal show={show} onHide={handleClose}>
                                <Modal.Header closeButton>
                                    <Modal.Title>
                                        <h4 className='m-0' style={{fontSize: "var(--font-16px)"}}>I'm Interested In This Property (APN: {singleTD.apn_id})</h4>
                                    </Modal.Title>
                                </Modal.Header>
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <Modal.Footer>
                                        ...
                                        <button className='btn btn-success'  style={{background: "var(--button-color)" , fontSize: "var(--font-14px)"}} onClick={handleSubmit} type='submit'>
                                            Submit
                                        </button>
                                    </Modal.Footer>
                                </form>
